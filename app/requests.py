...
def configure_request(app):
    """
    This function sets the configurations required for the requests
    """
...
def process_articles(articles):
    """
    This function processes the articles list from the api into a list of Article instances
    Args:list of articles
    Return:list of Article instances"
    """
    results =  []
